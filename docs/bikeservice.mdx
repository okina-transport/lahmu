...
```
{
    "operators": [
        {
            "name": "oslobysykkel",
            "url": "https://api.staging.entur.io/mobility/v1/bikes/oslobysykkel/gbfs.json"
        },
        {
            "name": "bergenbysykkel",
            "url": "https://api.staging.entur.io/mobility/v1/bikes/bergenbysykkel/gbfs.json"
        },
        {
            "name": "trondheimbysykkel",
            "url": "https://api.staging.entur.io/mobility/v1/bikes/trondheimbysykkel/gbfs.json"
        },
        {
            "name": "kolumbusbysykkel",
            "url": "https://api.staging.entur.io/mobility/v1/bikes/kolumbusbysykkel/gbfs.json"
        },
        {
            "name": "lillestrombysykkel",
            "url": "https://api.staging.entur.io/mobility/v1/bikes/lillestrombysykkel/gbfs.json"
        },
        {
            "name": "drammenbysykkel",
            "url": "https://api.staging.entur.io/mobility/v1/bikes/drammenbysykkel/gbfs.json"
        }
    ]
}
